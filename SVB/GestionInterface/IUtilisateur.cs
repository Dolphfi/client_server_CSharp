...
namespace GestionInterface
{
    public interface IUtilisateur
    {
        ...
        void ModifierEtat(int dat);

        #endregion

        #region"insertion user"
        int InsererUtilisateur(string co, string cod, string fon, string us, string pas, string moda, DateTime dat,int etat);
        ...
        bool RechercherutilisateurBak(string co);
        #endregion

        #region"Modification user"
        int Modifieruser(string co, string cod, string fonct, string us, string pas, string moda, DateTime dat,int etat);
