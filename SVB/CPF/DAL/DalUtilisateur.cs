...
namespace CFP.DAL
{
    class DalUtilisateur
    {
        ...
        public static Utilisateur Rechercherutilisateur(string cod)
        {
            ...
            try
            {
                ...
                if (rd.Read())
                {
                    ...
                    rech.setEtat(Convert.ToInt16(rd[7].ToString()));
        ...
        #region"methode rechercher utilisateur"
        public static Utilisateur RechercherutilisateurBak(string cod)
        {
            Utilisateur rech = new Utilisateur();
            string req = "Select * from bakutilisateur where code_utilisateur='" + cod + "' or code_empl='" + cod + "'";
            try
            {
                con.Open();
                cmd = new MySqlCommand(req, con);
        ...
        public static int ModifierUtilisateur(string co, string cod, string fon, string us, string pas,string moda, DateTime dat,int eta)
        {


            string req = "Update tblutilisateur set code_empl='" + cod + "', fonction='" + fon + "',user='" + us + "',password='" + pas + "',module_acces='" + moda + "',date_insc='" + dat + "',etat='" + eta + "' where code_utilisateur='" + co + "'";
            int ver = 0;
            try
            {
                con.Open();
