...
namespace CFP.application
{
    class CtrlUtilisateur
    {
        ...
        public void ModifierEtat(int eta)
        {
            this.ut.setEtat(eta);
        }
        ...
        public int InsererUtilisateur(string co, string cod, string fon, string us, string pas,string moda, DateTime dat,int eta)
        {
            ut = new Utilisateur (co, cod, fon, us, pas,moda, dat,eta);
        ...
        public int Modifieruser(string co, string cod, string fonct, string us, string pas,string moda, DateTime dat,int eta)
        {
            return DalUtilisateur.ModifierUtilisateur(co, cod, fonct, us, pas,moda, dat,eta);
