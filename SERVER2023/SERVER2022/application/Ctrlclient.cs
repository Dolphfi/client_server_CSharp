...
{
    class Ctrlclient : MarshalByRefObject, GestionInterface.IClient
    {
        ...
        public int InsererClient(string nm_c_c, string ty, string no,  string sex, string adres, string tel, string dat_de_N, string emai, string ni_c, DateTime dat)
        {
            cli = new Client(nm_c_c,ty,no ,sex, adres, tel, dat_de_N, emai, ni_c,dat);
